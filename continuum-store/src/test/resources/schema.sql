# This file was generated from the continuum-model
...
(
    ...
    LATEST_BUILD_ID INTEGER DEFAULT 0 NOT NULL,
    MODEL_ENCODING VARCHAR(256) NULL,
    PROFILE_ID_OID INTEGER NULL,
    SCHEDULE_ID_OID INTEGER NULL,
    PRIMARY KEY (ID)
);
...
(
    ...
    MODEL_ENCODING VARCHAR(256) NULL,
    VERSION VARCHAR(256) NULL,
    DEPENDENCIES_ID_OWN INTEGER NULL,
...
(
    ...
    CONTINUUM_ID INTEGER NOT NULL,
    EMAIL VARCHAR(256) NULL,
    MODEL_ENCODING VARCHAR(256) NULL,
    "NAME" VARCHAR(256) NULL,
    SCM_ID VARCHAR(256) NULL,
    DEVELOPERS_ID_OWN INTEGER NULL,
...
(
    ...
    DESCRIPTION VARCHAR(256) NULL,
    MAX_JOB_EXECUTION_TIME INTEGER NOT NULL,
    MODEL_ENCODING VARCHAR(256) NULL,
    "NAME" VARCHAR(256) NULL,
    PRIMARY KEY (ID)
);
...
ALTER TABLE BUILDDEFINITION ADD CONSTRAINT BUILDDEFINITION_FK1 FOREIGN KEY (PROFILE_ID_OID) REFERENCES PROFILE (ID) ;

ALTER TABLE BUILDDEFINITION ADD CONSTRAINT BUILDDEFINITION_FK2 FOREIGN KEY (SCHEDULE_ID_OID) REFERENCES SCHEDULE (ID) ;
...
ALTER TABLE BUILDRESULT ADD CONSTRAINT BUILDRESULT_FK1 FOREIGN KEY (TEST_RESULT_TESTRESULT_ID_OID) REFERENCES TESTRESULT (TESTRESULT_ID) ;

ALTER TABLE BUILDRESULT ADD CONSTRAINT BUILDRESULT_FK2 FOREIGN KEY (PROJECT_ID_OID) REFERENCES PROJECT (ID) ;

ALTER TABLE BUILDRESULT ADD CONSTRAINT BUILDRESULT_FK3 FOREIGN KEY (SCM_RESULT_SCMRESULT_ID_OID) REFERENCES SCMRESULT (SCMRESULT_ID) ;
...
ALTER TABLE PROJECT ADD CONSTRAINT PROJECT_FK2 FOREIGN KEY (PARENT_PROJECTDEPENDENCY_ID_OID) REFERENCES PROJECTDEPENDENCY (PROJECTDEPENDENCY_ID) ;

ALTER TABLE PROJECT ADD CONSTRAINT PROJECT_FK3 FOREIGN KEY (CHECKOUT_RESULT_SCMRESULT_ID_OID) REFERENCES SCMRESULT (SCMRESULT_ID) ;
