...
public class AddingResultUtil
{
    ...
    static 
    {
        ...
        errorMap.put( "add.project.missing.pom.error", "POM file does not exist. Either the POM you specified or one of its modules does not exist." );
        ...
        errorMap.put( "add.project.missing.scm.connection.error", "Missing 'connection' sub-element in the 'scm' element in the POM." );
        errorMap.put( "add.project.missing.notifier.type.error", "Missing 'type' sub-element in the 'notifier' element in the POM." );
        errorMap.put( "add.project.missing.notifier.configuration.error", "Missing 'configuration' sub-element in the 'notifier' element in the POM." );
        errorMap.put( "add.project.metadata.transfer.error", "Transfer of Metadata has failed." );
        errorMap.put( "add.project.validation.protocol.not_allowed", "The specified resource isn't a file or the protocol used isn't allowed." );
        errorMap.put( "add.project.unauthorized.error", "You are not authorized to access the requested URL. Please verify that the correct username and password are provided." );
        errorMap.put( "add.project.artifact.not.found.error", "Missing artifact trying to build the POM. Check that its parent POM is available or add it first in Continuum." );
        errorMap.put( "add.project.project.building.error", "Unknown error trying to build POM." );
        errorMap.put( "add.project.unknown.error", "The specified resource cannot be accessed. Please try again later or contact your administrator." );
